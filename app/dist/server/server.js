...
const NodeResponse = /* @__PURE__ */ (() => {
  ...
  class NodeResponse2 {
    ...
    get _response() {
      ...
      __privateSet(this, _response, new NativeResponse(body, __privateGet(this, _headers2) ? {
...
var HTTPError = class HTTPError2 extends Error {
  constructor(arg1, arg2) {
    ...
    const status = sanitizeStatusCode((details == null ? void 0 : details.status) || (details == null ? void 0 : details.statusCode) || ((_a3 = details == null ? void 0 : details.cause) == null ? void 0 : _a3.status) || ((_b2 = details == null ? void 0 : details.cause) == null ? void 0 : _b2.statusCode), 500);
    const statusText = sanitizeStatusMessage((details == null ? void 0 : details.statusText) || (details == null ? void 0 : details.statusMessage) || ((_c = details == null ? void 0 : details.cause) == null ? void 0 : _c.statusText) || ((_d = details == null ? void 0 : details.cause) == null ? void 0 : _d.statusMessage));
    const message = messageInput || (details == null ? void 0 : details.message) || ((_e2 = details == null ? void 0 : details.cause) == null ? void 0 : _e2.message) || (details == null ? void 0 : details.statusText) || (details == null ? void 0 : details.statusMessage) || [
      "HTTPError",
      status,
      statusText
    ].filter(Boolean).join(" ");
    ...
    const rawHeaders = (details == null ? void 0 : details.headers) || ((_f = details == null ? void 0 : details.cause) == null ? void 0 : _f.headers);
    this.headers = rawHeaders ? new Headers(rawHeaders) : void 0;
    this.unhandled = (details == null ? void 0 : details.unhandled) ?? ((_g = details == null ? void 0 : details.cause) == null ? void 0 : _g.unhandled) ?? void 0;
...
function prepareResponse(val, event, config, nested) {
  ...
  if (val && val instanceof Error) {
    ...
    const errHeaders = (_a3 = event[kEventRes]) == null ? void 0 : _a3[kEventResErrHeaders];
...
function executeRewriteInput(rewrite, url) {
  var _a3;
  const res = (_a3 = rewrite == null ? void 0 : rewrite.input) == null ? void 0 : _a3.call(rewrite, { url });
  if (res) {
...
function createHistory(opts) {
  ...
  return {
    ...
    block: (blocker) => {
      ...
      return () => {
        var _a4, _b2;
        const blockers2 = ((_a4 = opts.getBlockers) == null ? void 0 : _a4.call(opts)) ?? [];
...
function getManifestScriptFormat(manifest2) {
  return (manifest2 == null ? void 0 : manifest2.scriptFormat) ?? "module";
}
...
async function getStartManifest(matchedRoutes) {
  var _a3;
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-Dzsi4dyp.js");
  ...
  for (const k2 in routes) {
    ...
    if ((_a3 = v2.css) == null ? void 0 : _a3.length) result.css = v2.css;
...
async function getFailureResponse(opts, ctx) {
  ...
  return ((_a3 = opts.failureResponse) == null ? void 0 : _a3.clone()) ?? new Response("Forbidden", {
    status: 403
  });
}
function getDefaultSerovalPlugins() {
  var _a3, _b2;
  return [...((_b2 = (_a3 = getStartOptions()) == null ? void 0 : _a3.serializationAdapters) == null ? void 0 : _b2.map(makeSerovalPlugin)) ?? [], ...defaultSerovalPlugins];
}
...
function collectStaticHintsFromManifest(manifest2, matchedRoutes) {
  ...
  for (const route of matchedRoutes) {
    ...
    for (const link of routeManifest.css ?? []) {
      ...
      if (((_a3 = manifest2.inlineCss) == null ? void 0 : _a3.styles[stylesheetHref]) !== void 0) continue;
...
async function transformInlineCssStyles(inlineCss, transformFn) {
  ...
  const transformedEntries = await Promise.all(Object.entries(inlineCss.styles).map(async ([stylesheetHref, css]) => {
    var _a3;
    const template = (_a3 = inlineCss.templates) == null ? void 0 : _a3[stylesheetHref];
...
async function transformManifestAssets(source, transformFn, _opts) {
  ...
  for (const route of Object.values(manifest2.routes)) {
    if ((_a3 = route.preloads) == null ? void 0 : _a3.length) route.preloads = await Promise.all(route.preloads.map(async (link) => {
    ...
    if (((_b2 = route.css) == null ? void 0 : _b2.length) && !manifest2.inlineCss) route.css = await Promise.all(route.css.map(async (link) => {
...
var ScriptBuffer = class {
  ...
  */
  ...
  injectBufferedScripts() {
    ...
    if (scriptsToInject) (_a3 = this.injectScript) == null ? void 0 : _a3.call(this, scriptsToInject);
  }
  cleanup() {
...
function getInlineCssForPreparedRoutes(manifest2, preparedRoutes) {
  ...
  const styles = (_a3 = manifest2.inlineCss) == null ? void 0 : _a3.styles;
  const hrefs = preparedRoutes.inlineCssHrefs;
  if (!styles || !(hrefs == null ? void 0 : hrefs.length)) return void 0;
  let css = "";
...
function prepareMatchedManifestRoutes(manifest2, matches) {
  var _a3;
  const inlineStyles = (_a3 = manifest2.inlineCss) == null ? void 0 : _a3.styles;
  const routes = {};
  if (!inlineStyles) {
    for (const match of matches) {
...
function hasRouteAssets(route) {
  var _a3, _b2;
  return !!((_a3 = route.scripts) == null ? void 0 : _a3.length) || !!((_b2 = route.css) == null ? void 0 : _b2.length);
}
function hasRequestAssets(assets) {
  var _a3;
  return !!assets && (!!((_a3 = assets.preloads) == null ? void 0 : _a3.length) || hasRouteAssets(assets));
}
function mergeRequestAssetsIntoRootRoute(rootRoute, requestAssets) {
  var _a3, _b2, _c;
  const preloads = ((_a3 = requestAssets == null ? void 0 : requestAssets.preloads) == null ? void 0 : _a3.length) ? [...requestAssets.preloads, ...(rootRoute == null ? void 0 : rootRoute.preloads) ?? []] : rootRoute == null ? void 0 : rootRoute.preloads;
  const scripts = ((_b2 = requestAssets == null ? void 0 : requestAssets.scripts) == null ? void 0 : _b2.length) ? [...requestAssets.scripts, ...(rootRoute == null ? void 0 : rootRoute.scripts) ?? []] : rootRoute == null ? void 0 : rootRoute.scripts;
  const cssLinks = ((_c = requestAssets == null ? void 0 : requestAssets.css) == null ? void 0 : _c.length) ? [...requestAssets.css, ...(rootRoute == null ? void 0 : rootRoute.css) ?? []] : rootRoute == null ? void 0 : rootRoute.css;
  return {
    ...rootRoute ?? {},
    ...(preloads == null ? void 0 : preloads.length) ? { preloads } : {},
    ...(scripts == null ? void 0 : scripts.length) ? { scripts } : {},
    ...(cssLinks == null ? void 0 : cssLinks.length) ? { css: cssLinks } : {}
  };
}
function attachRouterServerSsrUtils({ router, manifest: manifest2, getRequestAssets }) {
  ...
  router.ssr = { get manifest() {
    ...
    const requestAssets = getRequestAssets == null ? void 0 : getRequestAssets();
  ...
  const serverSsr = {
    ...
    injectScript: (script) => {
      ...
      const html = `<script${((_a4 = router.options.ssr) == null ? void 0 : _a4.nonce) ? ` nonce='${router.options.ssr.nonce}'` : ""}>${script}<\/script>`;
    ...
    dehydrate: async (opts) => {
      ...
      if (manifest2) {
        ...
        const requestAssets = opts == null ? void 0 : opts.requestAssets;
      ...
      const lastMatchId = (_a4 = matchesToDehydrate[matchesToDehydrate.length - 1]) == null ? void 0 : _a4.id;
      if (lastMatchId) dehydratedRouter.lastMatchId = dehydrateSsrMatchId(lastMatchId);
      const dehydratedData = await ((_c = (_b2 = router.options).dehydrate) == null ? void 0 : _c.call(_b2));
    ...
    takeBufferedScripts() {
      ...
      return {
        tag: "script",
        attrs: {
          nonce: (_a4 = router.options.ssr) == null ? void 0 : _a4.nonce,
          className: "$tsr",
  ...
  for (const listener of ((_a3 = router.serverSsrLifecycle) == null ? void 0 : _a3.onServerSsrAttach) ?? []) try {
    listener(serverSsr);
  } catch (err) {
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./assets/router-BP52tOsn.js"),
...
function createStartHandler(cbOrOptions) {
  ...
  const startRequestResolver = async (request, requestOpts) => {
    ...
    try {
      ...
      const startOptions = await ((_a3 = entries.startEntry.startInstance) == null ? void 0 : _a3.getOptions()) || {};
      ...
      const executeRouter = async (serverContext, matchedRoutes) => {
        ...
        attachRouterServerSsrUtils({
          ...
          getRequestAssets: () => {
            var _a4;
            return (_a4 = getStartContext({ throwIfNotFound: false })) == null ? void 0 : _a4.requestAssets;
          }
        });
...
async function handleServerRoutes({ getRouter, request, url, executeRouter, context, executedRequestMiddlewares }) {
  ...
  for (const route of matchedRoutes) {
    const serverMiddleware = (_a3 = route.options.server) == null ? void 0 : _a3.middleware;
    if (serverMiddleware) {
  ...
  if ((server2 == null ? void 0 : server2.handlers) && isExactMatch) {
    ...
    if (handler) {
      ...
      if (typeof handler === "function") routeMiddlewares.push(handlerToMiddleware(handler, mayDefer));
        ...
        if ((_b2 = handler.middleware) == null ? void 0 : _b2.length) {
